...
Completed: 1, 2, 3, 4, 5. The registry covers documented API-key endpoints and rejects unsupported protocols explicitly. Each step is a meaningful commit and includes the affected documentation.
